            ...
            <div class="tpl-block">
                ...
                <div class="am-g">
                    <div class="tpl-form-body tpl-form-line">
                        <form class="am-form tpl-form-line-form" action="${pageContext.request.contextPath}/movie/add-movie" method="post" enctype="multipart/form-data">
                            <!-- 这是一个input开始 -->
                            <div class="am-form-group">
                                <label for="user-name" class="am-u-sm-3 am-form-label">电影名称 <span class="tpl-form-line-small-title">Name</span></label>
                                <div class="am-u-sm-9">
                                    <input name="moviename" type="text" class="tpl-form-input" id="user-name" placeholder="请输入电影名称">
                                    <small></small>
                                </div>
                            </div>
                            <!-- 这是一个input结束 -->
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input name="time" type="text" class="am-form-field tpl-form-no-bg" placeholder="电影时长" data-am-datepicker=""/>
                                    <small></small>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input name="url" type="text" class="tpl-form-input" id="url" placeholder="请输入电影播放路径">
                                    <small></small>
                                </div>
                            </div>
                            <!-- 这是一个input开始 -->
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input name="imagepath" type="text" class="tpl-form-input" id="imagepath" placeholder="请输入电影图片路径">
                                    <small></small>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input name="director" type="text" placeholder="输入导演名字">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input name="score" type="text" placeholder="输入评分">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <textarea name="keyword" class="" rows="10" id="keyword" placeholder="请输入关键字"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <input name="categroy" type="text" id="user-weibo" placeholder="请添加分类用点号隔开">
                                    <div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
                                    <textarea name="des" class="" rows="10" id="user-intro" placeholder="请输入描述内容"></textarea>
                                </div>
                            </div>
